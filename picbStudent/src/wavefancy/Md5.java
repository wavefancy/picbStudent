package wavefancy;
	...
	/*************************************************
	keyBean ��ʵ����RSA Data Security, Inc.���ύ��IETF
	��RFC1321�е�keyBean message-digest �㷨��
	*************************************************/
	public class Md5 {
	...
	/* ����������Ա��keyBean���������õ���3��������ݣ���ԭʼ��Cʵ����
	�����嵽keyBean_CTX�ṹ��
	*/
	private long[] state = new long[4]; // state (ABCD)
	private long[] count = new long[2]; // number of bits, modulo 2^64 (lsb first)
	private byte[] buffer = new byte[64]; // input buffer
	/* digestHexStr��keyBean��Ψһһ��������Ա��������һ�μ������
	16����ASCII��ʾ.
	*/
